  ...
  return (
    <main className="content">
      <section className="intro">
        <div className="profile">
          <div className="profile__picture">
            ...
            <img className="profile__picture-avatar" src={currentUser.avatar} alt="фото профиля" />
          </div>
      ...
      <section className="photo-cards-container" aria-label="карточки с фотографиями" >
        ...
        {props.cards.map((card) => (<Card key={card._id} card = {card} onCardClick={props.onCardClick} onClickCardDelete={props.onClickCardDelete} onConfirmClick={props.onConfirmClick} onCardLike={props.onCardLike}/>))}
